...
export default function AddPropertyModal({ show, onClose }: AddPropertyModalProps) {
  ...
  const handleSubmit = (values: PropertyFormData, { setSubmitting, resetForm }: any) => {
      ...
      <div className={styles.add_property_modal_content}>
        <div className={styles.add_property_modal_input_section}>
          <Input
            ...
            error={touched.propertyName && errors.propertyName ? errors.propertyName : undefined}
          />
          <Input  
            label="Property Code"
            ...
            inputStyle={styles.add_property_modal_input_section_input}
            inputContainerClass={styles.add_property_modal_input_container}
            error={touched.propertyCode && errors.propertyCode ? errors.propertyCode : undefined}
          />
          <Input
            label="Property Type"
            ...
            inputStyle={styles.add_property_modal_input_section_input}
            inputContainerClass={styles.add_property_modal_input_container}
            error={touched.propertyType && errors.propertyType ? errors.propertyType : undefined}
          />
          <Input
            label="Address*"
          ...
          <Input
            ...
            inputStyle={styles.add_property_modal_input_section_input}
            inputContainerClass={styles.add_property_modal_input_container}
            error={touched.grossArea && errors.grossArea ? errors.grossArea : undefined}
          />
          <Input
            ...
            inputStyle={styles.add_property_modal_input_section_input}
            inputContainerClass={styles.add_property_modal_input_container}
            error={touched.primaryContactName && errors.primaryContactName ? errors.primaryContactName : undefined}
          />
          <Input
            label="Email*"
            value={values.email}
