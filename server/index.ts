...
console.log(
  "- COSMOS_DB_ENDPOINT:",
  process.env.COSMOS_DB_ENDPOINT ? "Set" : "Not set"
);
console.log("- COSMOS_DB_KEY:", process.env.COSMOS_DB_KEY ? "Set" : "Not set");
console.log(
  "- COSMOS_DB_NAME:",
  process.env.COSMOS_DB_NAME || "planor-portal (default)"
);
console.log(
  "- MAILJET_API_KEY:",
...
console.log(
  "- MAILJET_SECRET_KEY:",
  process.env.MAILJET_SECRET_KEY ? "Set" : "Not set"
);
console.log(
  "- MAILJET_SENDER_EMAIL:",
  process.env.MAILJET_SENDER_EMAIL || "no-reply (default)"
);
